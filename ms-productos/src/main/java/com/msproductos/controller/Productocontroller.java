...
//es lo mismo que la clase service
public class Productocontroller {
	...
	// http://localhost:8095/v1/productos (GET MUESTRA TODOS)
	...
	// http://localhost:8095/v1/productos/buscar-por-id/30 (GET BUSCA UNO ESPECIFICADO)
	...
	// http://localhost:8095/v1/productos/eliminar/30 (DELETE ELIMINA)
