...
public class Smartwatch extends Reloj{
	...
	public Smartwatch(String tipo, String color, String forma, String material, String mecanismo, String tamano,
			double precio, String so, String sensores, Pantalla p1) {
		super(tipo, color, forma, material, mecanismo, tamano, precio);
		this.so = so;
		this.sensores = sensores;
		this.p1 = p1;
	}
	...
	public String toString() {
		return "Smartwatch [so=" + so + ", sensores=" + sensores + ", p1=" + p1 + ", tipo=" + tipo + ", color=" + color
				+ ", forma=" + forma + ", material=" + material + ", mecanismo=" + mecanismo + ", tamano=" + tamano
				+ ", precio=" + precio + "]";
	}
