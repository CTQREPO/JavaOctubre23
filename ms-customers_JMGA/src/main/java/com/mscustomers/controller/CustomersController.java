...
public class CustomersController {
	...
	//http://localhost:8096/v1/customers
	@PostMapping
	...
	//http://localhost:8096/v1/customers/buscar-por-id/{id}
	 @GetMapping("buscar-por-id/{id}") 
	 ResponseEntity<Customers> buscar(@PathVariable int id){ 
	  Customers cust = service.buscar(id); 
	  return new ResponseEntity<Customers>(cust,HttpStatus.OK); 
	 } 
	//http://localhost:8096/v1/customers/eliminar/{id}
	...
	//http://localhost:8096/v1/customers/buscar-por-nombre/nombre
