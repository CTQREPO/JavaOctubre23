package com.ms.productos.advice;
...
import com.ms.productos.errors.ApiErrors;
...
private static final String NO_ENCONTRADO = "No se encontró el recurso";
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		// TODO Auto-generated method stub
		List<String> detalles = new ArrayList<String>(); 
		  ex.getBindingResult().getFieldErrors().forEach(error -> { //toma todos los mensajes de los errores
