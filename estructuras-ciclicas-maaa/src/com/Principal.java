...
public class Principal {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out.println("Cantidad de numeros a ingresar"); cantidad =
		 * sc.nextInt();
		 * 
		 * while(contador<cantidad) { System.out.println("Ingresa un numero);");numero =
		 * sc.nextInt(); suma+=numero; contador++; } System.out.println(suma);
		...
		*/
		...
		//Ejercicio hacer una tabla de multiplicar
